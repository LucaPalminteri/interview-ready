import QuestionnaireComponent from "./questionnaire/main";
...
export default function Questionnaire() {
  return (
    <>
      <h1>Questionnaire</h1>
      <p>
        We want to build a Multiple choice Questionnaire. After submission, we calculate a score
        ...
        After submitting the questionnaire, each of the users answers must be compared with the
